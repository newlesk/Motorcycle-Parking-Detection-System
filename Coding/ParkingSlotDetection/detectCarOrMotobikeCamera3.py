...
if args.video:
    ...
    #cap = cv2.VideoCapture("datasets/parkinglot_1_480p.mp4")
    #cap = cv2.VideoCapture("http://10.8.10.116:8080/videostream.cgi?user=admin&pwd=12345678")
    ...
    for x in range(0, 20):
        ...
        try:
            ...
            if(True):
                ...
                docRefCamera = db.collection(u'parking').document(u'cameraP3')
                docRefCamera.set({
                    u'base64C3': image_code
                    })
